...
let s:cursorLineNr = { 'gui': '#676e95', 'cterm': 60 }
...
let s:cursorLineNr = { 'gui': '#e0e2e9', 'cterm': 60 }
let s:line_numbers = { 'gui': '#8389a8', 'cterm': 60 }
...
let g:material_colorscheme_map.line_numbers = s:invisibles
...
call s:SetHighlight('CursorLineNr', s:cursorLineNr, '', '')
